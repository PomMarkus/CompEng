...
code_button = tk.Button(window, text="\U0001F511", command=lambda: [pause_game(), show_code_overlay()], font=("Arial", 14, "bold"), bg="#471F01", fg="white", bd=0, relief="flat", cursor="hand2")
